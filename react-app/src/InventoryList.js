    ...
    const inventoryList = inventories.map(inventory => {
      return (
        <tr key={inventory._id}>
          ...
          <td>
            <ButtonGroup>
              <Button size="sm" color="primary" tag={Link} to={"/inventory/" + inventory._id}>
                Edit
              </Button>
              <Button size="sm" color="danger" onClick={() => this.remove(inventory._id)}>
                Delete
              </Button>
            </ButtonGroup>
          </td>
      ...
      <div>
        ...
        <Container fluid>
          <div className="float-end">
            <Button color="success" tag={Link} to="/inventory/new">
              Add Inventory
            </Button>
          </div>
